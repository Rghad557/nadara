        ...
        <div class="login-card">
            ...
            <form action="login.php" method="POST">
                ...
                <div class="options" style="font-size: 0.8rem;">
                    ...
                    <a href="javascript:void(0)" onclick="alert('System Admin: Please check the database credentials or contact support.');" style="color: #E8B4B8; text-decoration: none;">Forgot?</a>
                </div>
